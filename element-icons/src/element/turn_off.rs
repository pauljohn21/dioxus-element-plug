...
pub fn TurnOff(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("fill", "currentColor"), attr("d", "M330 621.2a109.2 109.2 0 1 0 0-218.4 109.2 109.2 0 0 0 0 218.4m0 72.8a182 182 0 1 1 0-364 182 182 0 0 1 0 364")]),
    ])];
