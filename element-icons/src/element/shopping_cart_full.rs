...
pub fn ShoppingCartFull(props: IconProps) -> Element {
    static TEMPLATE_ROOTS: &[TemplateNode] = &[svg(&[
        ...
        path(&[attr("fill", "currentColor"), attr("d", "M699.6 256 608 146l-91.6 110zM558.8 105a64 64 0 0 1 98.4 0l179.2 215H379.6z")]),
    ])];
